...
act['1'] = activities.ActivityEdge(source=act['start'], target=act['fork'])
act['2'] = activities.ActivityEdge(source=act['fork'], target=act['action1'])
act['3'] = activities.ActivityEdge(source=act['fork'], target=act['action2'])
act['4'] = activities.ActivityEdge(source=act['action1'], target=act['action3'])
act['5'] = activities.ActivityEdge(source=act['action2'], target=act['join'])
act['6'] = activities.ActivityEdge(source=act['action3'], target=act['decision'])
act['7'] = activities.ActivityEdge(source=act['action3'], target=act['join'])
act['8'] = activities.ActivityEdge(source=act['decision'], target=act['flow end'], guard="else")
act['9'] = activities.ActivityEdge(source=act['decision'], target=act['merge'], guard="True")
act['10'] = activities.ActivityEdge(source=act['join'], target=act['merge'])
act['11'] = activities.ActivityEdge(source=act['merge'], target=act['end'])
